...
export default function Content({ showProfile, setShowProfile }) {
  return (
    <div className="content">
      <div className="part1">
        <h1 className="whwear">Who We Are</h1>
        <p className="whweartext">
          We are not just a bakery, we are not bakers. In fact, we are just like
          you, a bunch of food lovers fascinated with sweet indulgence, who
      ...
      <div className="part2">
        ...
        <button class="button" onClick={() => setShowProfile((prev) => !prev)}>
        ...
        <p className="OStext3">
          ...
          commitment to both our customers, franchise partners & distributors is
          the key to our success in the future. We are dedicated to creating a
          dynamic environment, conducting ourselves with the highest integrity
          for every component in our value chain: our customers, suppliers, team
          members, and franchise partners. By acting in the best interest of
          everyone along our value chain, we are able to ensure our company's
          sweet success..
        </p>
      </div>
    </div>
